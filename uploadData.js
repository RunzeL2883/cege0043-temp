...
function processData(postString) {
    ...
    client.open('POST','http://developer.cege.ucl.ac.uk:30290/reflectData',true);
...
// create the code to wait for the response from the data server, and process theresponse once it is received
